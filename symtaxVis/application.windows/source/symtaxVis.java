...
public class symtaxVis extends PApplet {
  ...
  { 
    ...
    else if(state ==6)
    {
      if(i < bufferSize - 4)
      {
        ...
        ellipse((width/1.5f), (height/2), myfft.spectrum[i]*400, myfft.spectrum[i]*400);
        ellipse((width/1.5f), (height/2), myfft.spectrum[i+1]*400, myfft.spectrum[i+1]*400);
        ellipse((width/1.5f), (height/2), myfft.spectrum[i+2]*400, myfft.spectrum[i+2]*400);
                if(i+randomBlue>255)
        {fill(0,255,0);}
        else{
        fill(0,randomBlue+i,0);}
        ellipse((width/1.5f), (height/2), myfft.spectrum[i+3]*400, myfft.spectrum[i+3]*400);
                noFill();
        stroke(0,randomBlue,0);
...
public void branch(float h) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#DFDFDF", "symtaxVis" });
  }
}
